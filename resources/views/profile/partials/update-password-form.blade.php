<section class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
    <h2 class="text-xl font-bold text-gray-800 mb-2">Update Password</h2>
        ...
        <div>
            ...
            <div class="relative">
                <input type="password" id="update_current_password" name="current_password" required 
                       class="w-full p-3 pr-12 bg-white text-gray-900 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#DD88CF] focus:border-[#DD88CF] outline-none transition-all shadow-sm">
...
<script>
    function togglePassword(inputId, iconId) {
        ...
        if (input.type === 'password') {
            ...
            icon.classList.add('bi-eye-slash'); // Berubah jadi ikon dicoret saat terlihat
        } else {
            input.type = 'password';
            icon.classList.remove('bi-eye-slash');
            icon.classList.add('bi-eye'); // Berubah kembali ke mata normal
        }
    }
</script>