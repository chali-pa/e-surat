...
<head>
    ...
    <title>Tambah Surat Keluar - E-Surat</title>
...
<body>
    ...
    <main class="main-content min-h-screen p-4 md:p-8">
        ...
        <header class="bg-gradient-to-r from-[#4B164C] to-[#DD88CF] shadow-md p-5 flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center rounded-2xl mb-8 max-w-3xl mx-auto">
            <h2 class="text-xl font-bold text-white">Tambah Surat Keluar Baru</h2>
            ...
            <form action="{{ route('surat_keluar.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="tanggal_keluar" name="tanggal_keluar" value="{{ old('tanggal_keluar') }}" required autocomplete="off" placeholder="Pilih tanggal"
