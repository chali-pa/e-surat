...
<body>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="email" id="email" name="email" value="{{ old('email', $request->email) }}" class="form-input" required readonly>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="password" id="password" name="password" placeholder="Masukkan password baru" class="form-input" required autofocus>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Ulangi password baru" class="form-input" required>
    ...
    <div class="deco-panel">
        ...
        <div class="deco-card">
            ...
            <h2 class="deco-title">Pembaruan<br><span>Sistem</span></h2>
            <p class="deco-desc">Selalu jaga kerahasiaan password Anda untuk keamanan informasi.</p>
        </div>
    </div>
