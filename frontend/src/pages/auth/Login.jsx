    ...
    <div className="min-h-screen flex" style={{ background: '#0d0015' }}>
      ...
      <div className="w-full lg:w-[45%] bg-white flex flex-col p-8 lg:p-[60px_56px] relative z-10 overflow-y-auto max-h-screen">
        ...
        <p className="text-sm text-gray-500 mb-10 leading-relaxed">
          Masuk ke akun Anda untuk mengelola surat elektronik dengan mudah dan efisien.
        </p>

        {/* Tab Switcher */}
        <div className="flex bg-gray-100 rounded-xl p-1 mb-8 gap-1">
          <Link to="/login" className="flex-1 py-2 px-5 rounded-lg text-sm font-semibold text-white transition-all" style={{ background: 'linear-gradient(135deg, #4B164C, #9c2fa0)', boxShadow: '0 4px 12px rgba(75, 22, 76, 0.35)' }}>
            Masuk
          </Link>
          <Link to="/register" className="flex-1 py-2 px-5 rounded-lg text-sm font-semibold text-gray-500 transition-all hover:text-gray-700">
            Daftar
          </Link>
        </div>
          ...
          <div className="flex justify-between items-center mb-6">
            <label className="flex items-center gap-1.5 text-xs text-gray-500 cursor-pointer">
              <input
                ...
                style={{ accentColor: '#4B164C' }}
              />
              Ingat saya
            </label>
            <Link to="/forgot-password" className="text-xs font-medium text-purple-600 hover:text-purple-800">
              Lupa Password?
            </Link>
          </div>
        ...
        <div className="text-center text-xs text-gray-500 mt-2">
          Belum punya akun? <Link to="/register" className="font-semibold text-purple-600 hover:text-purple-800">Daftar sekarang</Link>
        </div>
