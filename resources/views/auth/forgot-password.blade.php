...
<body>
    <div class="form-panel">
        ...
        <h1 class="welcome-heading">Lupa Password?</h1>
        <p class="welcome-sub">Masukkan alamat email Anda dan kami akan mengirimkan tautan untuk mereset password agar Anda bisa kembali mengakses akun.</p>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="nama@email.com" class="form-input" required autofocus>
        ...
        <div class="footer-text">
            Ingat password Anda? <a href="{{ route('login') }}">Kembali ke Masuk</a>
        </div>
    </div>
    ...
    <div class="deco-panel">
        ...
        <div class="deco-card">
            ...
            <h2 class="deco-title">Keamanan<br><span>Akun Anda</span></h2>
            <p class="deco-desc">Kami memastikan data Anda tetap aman. Segera pulihkan akses Anda.</p>
        </div>
    </div>
</body>
</html>
