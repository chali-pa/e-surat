...
import { index, show, store, update, destroy, preview, serveFile, sendEmailSuratKeluar } from '../controllers/suratKeluarController';
import { outgoingMonthlyPdf } from '../controllers/reportController';
