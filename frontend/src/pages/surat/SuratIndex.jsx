    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="overflow-x-auto" style={{ overflowX: 'auto' }}>
          {loading ? (
            <div className="text-center py-16 text-slate-400" style={{ textAlign: 'center', padding: '64px 0', color: '#94a3b8' }}>
              <i className="bi bi-arrow-repeat text-4xl mb-3 block animate-spin" style={{ fontSize: '36px', display: 'block', marginBottom: '12px' }}></i>
              Memuat data...
            </div>
          ) : (
            <table className="w-full min-w-[780px]" style={{ width: '100%', minWidth: '780px', borderCollapse: 'collapse' }}>
              <thead>
