...
export default function SuratCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) navigate('/surat')
    } catch (error) {
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h1 className="text-2xl font-bold text-[#4B164C]">Tambah Surat Masuk</h1>
          </div>
          <p className="text-sm text-slate-500 ml-10">Isi detail surat masuk baru dengan lengkap dan benar.</p>
        </div>
        <Link
          to="/surat"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={inputClass('nama_pengirim') + ' pl-9'}
                    placeholder="Nama instansi / perorangan"
                  />
                </div>
                {errors.nama_pengirim && (
                  <p className="text-red-500 text-xs flex items-center gap-1">
                    <i className="bi bi-exclamation-circle" /> {errors.nama_pengirim}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={inputClass('tanggal_masuk') + ' pl-9'}
                  />
                </div>
                {errors.tanggal_masuk && (
                  <p className="text-red-500 text-xs flex items-center gap-1">
                    <i className="bi bi-exclamation-circle" /> {errors.tanggal_masuk}
                  </p>
                )}
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <i className="bi bi-floppy" /> Simpan Surat Masuk
                  </>
                )}
              </button>
            </div>
